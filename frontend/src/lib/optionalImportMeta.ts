...
export const OPTIONAL_IMPORT_META: Record<OptionalImportKind, OptionalImportMeta> = {
  barcodes: {
    ...
    columns: ['codigo', 'codigobarras'],
    sampleRow: ['1001', '7891234567890'],
    sourceHint: 'Um produto pode ter vários EANs; repita o código do produto em cada linha.',
  ...
  supplierRefs: {
    ...
    description: 'Liga o código interno ao código usado pelo fornecedor.',
    columns: ['codigo', 'codigofornecedor', 'fornecedor'],
    sampleRow: ['1001', 'FORN-8842', 'DROGARIA XYZ'],
    sourceHint: 'Use o código de migração do produto e o código de catálogo do fornecedor.',
    exampleFileName: 'referencias-fornecedor.csv',
    whenToUse: 'Útil para pedidos e conferência de NF.',
  },
  validity: {
    id: 'validity',
